...
# python3 -m rl_utils.train_with_custom_rew --env-type pandemic --num-workers 10 --num-gpus 1 --num-iterations 100 --init-checkpoint
python3 -m rl_utils.train_with_custom_rew --env-type pandemic --no-convo-base-line --reward-fun-type learned_rew --num-workers 10 --num-gpus 1 --num-iterations 200
